...
abstract class AbstractClient
{
	...
	{
		$this->setAppId($credentials->getAppId());
		$this->setAppSecret($credentials->getApiSecret());
  ...
  protected function getUserFromAvailableData() {
    ...
    if ($access_token AND $access_token != $this->getApplicationAccessToken() AND !($user AND $persisted_access_token == $access_token))
	{
   ...
   */
	protected function getCode()
	{
		...
		{
			if ($this->state !== null AND isset($_REQUEST['state']) AND $this->state === $_REQUEST['state'])
			{
  ...
  protected function throwAPIException($result)
  {
	...
	{
		$e = new Exception\RuntimeException($result['error']['message'] . '  (by ' . $result['error']['type'] . ')', $result['error']['code']);
	}
	else
	{
